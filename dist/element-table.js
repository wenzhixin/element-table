(function (global, factory) {
	...
	(global = global || self, global.ElementTable = factory(global.$$1));
	...
	$$1.extend($$1.fn.bootstrapTable.defaults, {
	...
	$$1.fn.bootstrapTable.theme = 'element';
	$$1.BootstrapTable = class extends $$1.BootstrapTable {
	  initConstants() {
	    ...
	    this.constants.html.pageDropdown = ['<div class="el-menu el-menu--popup">', '</div>'], this.constants.html.pageDropdownItem = '<li class="el-menu-item %s"><a href="#">%s</a></li>', this.constants.html.toolbarDropdownSeparator = '<div class="el-dropdown-menu__item el-dropdown-menu__item--divided"></div>';
	    ...
	    this.constants.html.paginationItem = '<li class="page-item%s"><a class="page-link" aria-label="%s" href="javascript:void(0)">%s</a></li>', this.constants.html.inputGroup = '<div class="el-input el-input-group el-input-group--append">%s%s</div>';
	  ...
	  _initDropdown() {
	    ...
	    $dropdowns.off('click').on('click', e => {
	      const $this = $$1(e.currentTarget);
	      e.stopPropagation();
	      $dropdowns.not($this).removeClass('active');
	      $this.toggleClass('active');
	    });
	    $$1(document).off('click.bs.dropdown.element').on('click.bs.dropdown.element', () => {
	...
	*/
	...
	var install = {
	  install(Vue) {
	    Vue.component('ElementTable', BootstrapTable);
	  }
